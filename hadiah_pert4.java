...
public class hadiah_pert4 {
	...
	public static void main (String args[]){
		...
		if (tipepesawat == 1) {
			...
			System.out.println("Anda memilih pesawat A, silahkan lanjut ke pembayaran");
		} else 
		if (tipepesawat == 2) {
			hargatiketpesawat = 2000000;
			System.out.println("Anda memilih pesawat B, silahkan lanjut ke pembayaran");
		} else 
		if (tipepesawat == 3) {
			hargatiketpesawat = 1000000;
			System.out.println("Anda memilih pesawat C, silahkan lanjut ke pembayaran");
		} 
